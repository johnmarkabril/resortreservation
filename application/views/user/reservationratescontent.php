            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="row">
                        ...
                        <div class="col-md-12 padding-top-large">
                            <div class="reservation-form-title">Inclusion:</div>
                        </div>
                        <div class="col-md-12 padding-top-large">
                            <form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post" target="_top">
                                ...
                                <input type="hidden" name="item_number" value="<?php echo $rates->RATES_NO; ?>">
                                <input type="hidden" name="amount"  id="item_price" value="<?php echo $rates->RATES_PRICE; ?>">
                                <input type="hidden" name="return" value="<?php echo base_url(); ?>rates/success">
                                <input type='hidden' name='notify_url' value='<?php echo base_url(); ?>rates/success'>
